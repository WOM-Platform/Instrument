...
class ProvaLocation extends StatefulWidget {
  @override
  _ProvaLocationState createState() => new _ProvaLocationState();
}

class _ProvaLocationState extends State<ProvaLocation> {
