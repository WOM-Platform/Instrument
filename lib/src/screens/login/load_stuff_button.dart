...
class LoadStuffButton extends StatefulWidget {
  ...
  const LoadStuffButton({Key key, this.onAnimationFinished, this.onTap, this.loginBloc})
      : super(key: key);
      ...
      builder: (BuildContext context, state) {
        return GestureDetector(
          ...
          child: ControlledAnimation(
            playback:
                state is LoginLoading ? Playback.PLAY_FORWARD : Playback.PAUSE,
            tween: tween1,
...
//  void _listenToAnimationFinished2(status) {
